    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DebitAmount', models.BigIntegerField(blank=True, null=True)),
                ('CreditAmount', models.BigIntegerField(blank=True, null=True)),
                ('DebitAmountFC', models.BigIntegerField(blank=True, null=True)),
                ('CreditAmountFC', models.BigIntegerField(blank=True, null=True)),
