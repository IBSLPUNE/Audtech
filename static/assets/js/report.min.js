var Rollup = (function (exports) {
	...
	class RowManager {
	    ...
	    openSingleNode(rowIndex) {
	        ...
	        var visibleRows = this.bodyRenderer.visibleRows;
	        var rowsToShow = uniq$1(childrenToShow.concat( visibleRows)).sort(numberSortAsc);
	...
	class BodyRenderer {
	    ...
	    renderRows(rows) {
	        ...
	        this.visibleRows = rows.map(function (row) { return row.meta.rowIndex; });
	    }
	...
	class Style {
	    ...
	    setBodyStyle() {
	        ...
	        requestAnimationFrame(function () {
	            ...
	            var height = $.getStyle(this$1.bodyScrollable, 'height');
	            var scrollHeight = (this$1.bodyRenderer.hyperlist || {})._scrollHeight || Infinity;
